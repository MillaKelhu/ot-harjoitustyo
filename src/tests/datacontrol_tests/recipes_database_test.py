...
class TestUserDatabase(unittest.TestCase):
    def setUp(self):
        ...
        recipes_database.add_recipe(1, "Sandwich", "Take a bread and butter it.")
    ...
    def test_add_recipe_adds_previously_nonexistent_recipe_correctly(self):
        returns = recipes_database.add_recipe(2, "Salad", "Wash a salad and put its leaves in a bowl.")
        self.assertEqual(returns, True)
                               
    def test_add_recipe_prevents_duplicates(self):
        returns = recipes_database.add_recipe(1, "Sandwich", "Take a bread, butter it, and put a slice of cheese on it.")
