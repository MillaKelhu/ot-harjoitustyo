...
class CookbookAppFunctions:
    def __init__(self, user_database=default_user_database, recipes_database=default_recipes_database):
        self._user = None
    ...
    def set_chosen_recipe(self, recipe_name):
        self._chosen_recipe = self._recipes.search_recipe(self._user[0], recipe_name)
